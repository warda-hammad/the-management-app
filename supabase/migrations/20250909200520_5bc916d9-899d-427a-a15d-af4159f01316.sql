...
DROP POLICY IF EXISTS "Users can view tasks in their department" ON public.tasks;
...
DROP POLICY IF EXISTS "Users can update their assigned tasks or created tasks" ON public.tasks;
...
DROP POLICY IF EXISTS "Users can view files in their department" ON public.files;
